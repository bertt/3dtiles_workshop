...
# Install pg2b3dm
RUN wget https://github.com/Geodan/pg2b3dm/releases/download/v2.27.0/pg2b3dm-linux-x64.zip -P /home
RUN unzip /home/pg2b3dm-linux-x64.zip -d /usr/local/bin

# Install i3dm.export
RUN wget https://github.com/Geodan/i3dm.export/releases/download/v2.18.1/i3dm.export-linux-x64.zip -P /home
